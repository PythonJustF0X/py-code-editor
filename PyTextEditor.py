...
class Menubar:
    ...
    def show_about_message(self):
        box_title = "PyCodeEditor"
        box_message = "A Python text editor to edit Python coded by: JustF0X"
...
class Statusbar:
    ...
    def __init__(self, parent):
        ...
        self.status.set("PyCodeEditor - 0.1")
    ...
    def update_status(self, *args):
        if isinstance(args[0], bool):
            ...
            self.status.set("PyCodeEditor - 0.1 Gutenberg")


class PyText:

    def __init__(self, master):
        master.title("Untitled - PyCodeEditor")
    ...
    def set_window_title(self, name=None):
        if name:
            self.master.title(name + " - PyCodeEditor")
        else:
            self.master.title("Untitled - PyCodeEditor")
